...
let _messageSelectorCache: typeof import('src/components/MessageSelector.js') | null = null
const messageSelector =
  (): typeof import('src/components/MessageSelector.js') => {
    if (!_messageSelectorCache) {
      try {
        _messageSelectorCache = require('src/components/MessageSelector.js')
      } catch {
        // Fallback: in Node.js ESM mode, require() can't load this module
        // due to ESM-only transitive deps. Provide a minimal stub.
        _messageSelectorCache = {
          selectableUserMessagesFilter: () => true,
        } as any
      }
    }
    return _messageSelectorCache!
  }
