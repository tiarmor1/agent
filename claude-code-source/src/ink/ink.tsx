...
export default class Ink {
  ...
  constructor(private readonly options: Options) {
    ...
    const logReactError = (err: unknown) => { process.stderr.write(`[REACT ERROR] ${err}\n${(err as any)?.stack || ''}\n`) };
    this.container = reconciler.createContainer(this.rootNode, ConcurrentRoot, null, false, null, 'id', logReactError,
    // onUncaughtError
    logReactError,
    // onCaughtError
    logReactError,
